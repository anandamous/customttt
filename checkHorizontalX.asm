; checkHorizontalX.asm
; Anand T. Egan
; 2023-12-15
;
; For CS 301 Fall 2023
; Source Code for the checkHorizontalX function to be called by customttt.cpp
; Checks if the horizontal win condition was made by player X
